...
import { CQMReportsData, DrillEncounters, DrillPatient, DrillAuthor } from '../../_models';
...
export class CqmreportsComponent implements OnInit, AfterViewInit  {
    ...
    drilldownEncounterColumns = ['Action','Date_Start', 'Date_Stop', 'code', 'Code_System_Name', 'Code_Description','Status'];
    drilldownClientColumns = ['action','Patient_LastName', 'Patient_MiddleName', 'Patient_FirstName', 'Patient_DoB', 'Patient_Gender'];
    drilldownAuthorsColumns = ['actionn', 'Author_BusinessName','NameGiven','NameSuffix','Author_BusinessPhone'];
      ...
      public downloadAsPDF() {
          ...
          content: [
              ...
              table: {
                ...
                body: [
                  ...
                  [
                    ...
                    { text: this.patientlistmeasure.Location_phone, fillColor: "#e5f8f5", color: "black" },
                  ],
                ],
              },
            },
            ...
            {ul:[

              {
                fontSize: 9,
              text:
                "Reporting period :" + this.startdate+"-"+this.enddate,
              alignment: "left",
            }]
            },
            {
        ...
        pdfMake
          ...
          .download(
            this.patientlistmeasure.ReportId + ".pdf"
          );
      }
      ...
      onViewResults(queuedReportData: any) {
        ...
        this.firstencounter=formatDate(this.patientlistmeasure.First_Encounter, 'dd MMM yyyy','en-US');
        this.lastencounter=formatDate(this.patientlistmeasure.Last_Encounter, 'dd MMM yyyy','en-US');
        this.startdate=formatDate(this.patientlistmeasure.StartDate, 'dd/MM/yyyy','en-US');
        this.enddate=formatDate(this.patientlistmeasure.EndDate, 'dd/MM/yyyy','en-US');
            ...
            msr.push(
              ...
              ],
              {
                ...
                fontSize: 11,
                  bold: true,
                ul: [
                 [ element.eMeasure_Identifier_MAT === 138||(element.eMeasure_Identifier_MAT === 155 )?{ text: "Performance Rate 1 :" + element.Performance_Rate1}:{text: "Performance Rate  :" + element.Performance_Rate1}],
                 [ element.eMeasure_Identifier_MAT === 138||(element.eMeasure_Identifier_MAT === 155)?{ text: "Performance Rate 2 :" + element.Performance_Rate2,}:{text:"" }],
                 [ element.eMeasure_Identifier_MAT === 138||(element.eMeasure_Identifier_MAT === 155 )?{ text: "Performance Rate 3 :" + element.Performance_Rate3}:{text:"" }],
                 [ element.eMeasure_Identifier_MAT === 138||(element.eMeasure_Identifier_MAT === 155)?{ text: "Reporting Rate 1 :" + element.Reporting_Rate1,}:{text: "Reporting Rate  :" +element.Reporting_Rate1,}],
                 [ element.eMeasure_Identifier_MAT === 138||(element.eMeasure_Identifier_MAT === 155 )?{ text: "Reporting Rate 2 :" + element.Reporting_Rate2}:{text: ""}],
                 [ element.eMeasure_Identifier_MAT === 138||(element.eMeasure_Identifier_MAT === 155)?{ text: "Reporting Rate 3 :" + element.Reporting_Rate3,}:{text: ""}],
                    ...
                    ? [
                        ...
                        },
                        {
                          ...
                          ul: [
                           ...
                           [ (element.MeasureIdentifier === 155 && element.seq === 2)?{ text: "Reporting Stratum 3 :" + element.Reporting_Stratum1}:{text: ""}],
                           [ (element.MeasureIdentifier === 74)?{ text: "Reporting Stratum 3 :" + element.Reporting_Stratum3}:{text: ""}],
                           [element.MeasureIdentifier === 155&&element.seq === 2?{ text: "Reporting Stratum 4 :" + element.Reporting_Stratum2}:{text: ""}],
                           [element.MeasureIdentifier === 155&&element.seq === 3?{ text: "Reporting Stratum 5 :" + element.Reporting_Stratum1}:{text: ""}],
                           [element.MeasureIdentifier === 155&&element.seq === 3?{ text: "Reporting Stratum 6 :" + element.Reporting_Stratum2}:{text: ""}],
        ...
        if((PatientForm.lastName == "" || PatientForm.lastName == null)  && (PatientForm.firstName == "" || PatientForm.firstName == null) && (PatientForm.patientId == "" || PatientForm.patientId == null)){
          ...
          this.patientlistfilter =  this.getPatientListTabData.filter(function(data) {
            var PatientName = data.Patient_Name.split(', ');
              return PatientName[1].toLowerCase() == PatientForm.lastName.toLowerCase() || PatientName[0].toLowerCase() == PatientForm.firstName.toLowerCase() || data.PatientId.toLowerCase() == PatientForm.patientId.toLowerCase();
            });
            this.patientlistfilterlength = this.patientlistfilter.length;
        }
      }
      ...
      getCMSConditionsData(PatientId){
        ...
        this.customizedspinner = true;
        this.accountservice.getCQMReportsMeasurePatientMetInfo(req).subscribe((cmscoditions_data) => {
          ...
          if(this.measureidentifiler == 'CMS 68' || this.measureidentifiler == 'CMS 69' || this.measureidentifiler == 'CMS 74'
            || this.measureidentifiler == 'CMS 75' || this.measureidentifiler == 'CMS 127' || this.measureidentifiler == 'CMS 147'
            || this.measureidentifiler == 'CMS 165')
            {
              this.ipp_conditions = (this.DrilldownPatientData.IPPConditions != null) ? JSON.parse(this.DrilldownPatientData.IPPConditions): JSON.parse(this.ippconditions[this.measureidentifiler]);
              this.deno_conditions = (this.DrilldownPatientData.DenConditions != null) ? JSON.parse(this.DrilldownPatientData.DenConditions): JSON.parse(this.denconditions[this.measureidentifiler]);
              this.deno_exclu_conditions = (this.DrilldownPatientData.DenExclusionConditions != null) ? JSON.parse(this.DrilldownPatientData.DenExclusionConditions): JSON.parse(this.denexcluconditions[this.measureidentifiler]);
              this.num_conditions = (this.DrilldownPatientData.NumeratorConditions != null) ? JSON.parse(this.DrilldownPatientData.NumeratorConditions): JSON.parse(this.numconditions[this.measureidentifiler]);
              this.deno_excep_conditions = (this.DrilldownPatientData.DenExceptionConditions != null) ? JSON.parse(this.DrilldownPatientData.DenExceptionConditions): JSON.parse(this.denexcepconditions[this.measureidentifiler]);
            }
          else if(this.measureidentifiler == 'CMS 138'){
            this.ipp_conditions = (this.DrilldownPatientData.IPPConditions != null) ? JSON.parse(this.DrilldownPatientData.IPPConditions): JSON.parse(this.ippconditions[this.measureidentifiler]);
            this.deno_conditions = (this.DrilldownPatientData.DenConditions != null) ? JSON.parse(this.DrilldownPatientData.DenConditions): JSON.parse(this.denconditions[this.measureidentifiler]);
            this.deno_exclu_conditions = (this.DrilldownPatientData.DenExclusionConditions != null) ? JSON.parse(this.DrilldownPatientData.DenExclusionConditions): JSON.parse(this.denexcluconditions[this.measureidentifiler]);
            this.num_conditions = (this.DrilldownPatientData.NumeratorConditions != null) ? JSON.parse(this.DrilldownPatientData.NumeratorConditions): JSON.parse(this.numconditions.CMS138[this.populationdescription]);
            this.deno_excep_conditions = (this.DrilldownPatientData.DenExceptionConditions != null) ? JSON.parse(this.DrilldownPatientData.DenExceptionConditions): JSON.parse(this.denexcepconditions.CMS138[this.populationdescription]);
          }
            ...
            this.deno_exclu_conditions = (this.DrilldownPatientData.DenExclusionConditions != null) ? JSON.parse(this.DrilldownPatientData.DenExclusionConditions): JSON.parse(this.denexcluconditions[this.measureidentifiler]);
            this.deno_excep_conditions = (this.DrilldownPatientData.DenExceptionConditions != null) ? JSON.parse(this.DrilldownPatientData.DenExceptionConditions): JSON.parse(this.denexcepconditions[this.measureidentifiler]);
            this.num_conditions = (this.DrilldownPatientData.NumeratorConditions != null) ? JSON.parse(this.DrilldownPatientData.NumeratorConditions): JSON.parse(this.numconditions.CMS155[this.populationdescription]);
          }
        });
      }
      ...
      ippconditions = {
        'CMS 68': '{"has_birthdate":0, "age_gt_18": 0, "encountered":1, "encounter_met_ondate":1 }',
        'CMS 69': '{"has_brithdate":1, "age_gt_18": 1, "encountered":0, "encounter_met_ondate":0}',
        'CMS 74': '{"has_brithdate":1, "age_lt_20":0, "office_visit":0, "established_office_visit":1, "encountered_preventive_init" :1, "initial_office_visit": 0, "service_established_office_visit":0, "service_initial_office_visit":0, "encounter_met_ondate":0 }',
        'CMS 75': '{"has_brithdate":1, "age_lt_20":0, "office_visit":0, "established_office_visit":1, "encountered_preventive_init" :1, "initial_office_visit": 0, "service_established_office_visit":0, "service_initial_office_visit":0, "encounter_met_ondate":0 }',
        'CMS 127': '{"has_brithdate":1, "age_gte_65":1, "office_visit":0, "annual_wellness":1, "established_office_visit":1, "initial_office_visit":0, "home_health_service":1, "care_service_long_term":0, "nursing_facility_visit":1, "Discharge_service_nursing":0, "encounter_met_ondate":0 }',
        'CMS 138': '{ "has_brithdate":1, "age_gte_18":1, "health_assessment_individual":1, "health_assessment_initial":0, "home_healthcare":0, "health_reassessment":1, "occupational_therapy":0, "office_visit":1, "ophthalmological_services":0, "psych_visit_diagnostic":1, "psych_visit_psychotherapy":0, "psychoanalysis":1, "speech_hearing":0, "annual_wellness":1, "established_office_visit":0, "established_office_visit":0, "group_counseling":0, "services_other":1, "services_individual":1, "services_initial":1,"encounter_met_ondate":1}',
        'CMS 147': '{"has_brithdate":1, "age_gte_6":1, "peritoneal_dialysis":1, "peritoneal_dialysis_met_ondate":0, "hemodialysis":1, "hemodialysis_met_ondate":0, "office_visit":1, "outpatient":0, "care_service":1, "health_care":1, "patient_interaction":0, "initial_office_0_to_17":1, "initial_office_0_to_18":0, "individual_Counselling":1, "group_counselling":0, "care_service":1, "nursing_facility":0, "facility_visit":1, "wellness_visit":0, "established_office_visit":0, "service_office_visit":1, "encounter_met_ondate":1 }',
        'CMS 155': '{ "has_brithdate":1, "age_bw_3to17":1 , "office_visit":0, "individual":0, "establishe_office_visit":1, "initial_office_visit":0, "group_counseling":0, "home_healthcare":1, "encounter_on_metdate":0}',
        'CMS 165': '{ "has_brithdate":1, "age_bw_18to85":1, "office_visit":0, "wellness_visit":0, "established_office_visit":0, "Initial_office_visit":0, "home_healthcare":0, "encounter_met_ondate":0, "diagnosis_hypertension":0, "diagnosis_hypertension_6_less_after_metondate":1, "diagnosis_hypertension_overlap_met_ondate":0}'
      };

      denconditions = {
        'CMS 68': '{"has_birthdate":0, "age_gt_18": 0, "encountered":1, "encounter_met_ondate":1 }',
        'CMS 69': '{"has_brithdate":1, "age_gt_18": 0, "encountered":0, "encounter_met_ondate":0}',
        'CMS 74': '{"has_brithdate":1, "age_lt_20":0, "office_visit":0, "established_office_visit":1, "encountered_preventive_init":1, "initial_office_visit": 0, "service_established_office_visit":0, "service_initial_office_visit":0, "encounter_met_ondate":0 }',
        'CMS 75': '{"has_brithdate":1, "age_lt_20":0, "office_visit":0, "established_office_visit":1, "encountered_preventive_init":1, "initial_office_visit":0, "service_established_office_visit":0, "service_initial_office_visit":0, "encounter_met_ondate":0 }',
        'CMS 127': '{"has_brithdate":1, "age_gte_65":1, "office_visit":0, "annual_wellness":1, "established_office_visit":1, "initial_office_visit":0, "home_health_service":1, "care_service_long_term":0, "nursing_facility_visit":1, "Discharge_service_nursing":0, "encounter_met_ondate":0 }',
        'CMS 138': '{"tobacco_user":0, "has_brithdate":1, "age_gte_18":1 ,"health_assessment_individual":1, "health_assessment_initial":0, "home_healthcare":0, "health_reassessment":1, "occupational_therapy":0, "office_visit":1, "ophthalmological_services": 0, "psych_visit_diagnostic":1, "psych_visit_psychotherapy": 0, "psychoanalysis": 1, "speech_hearing":0, "annual_wellness":1, "established_office_visit":0, "established_office_visit":0, "group_counseling":0, "services_other":1, "services_individual":1, "services_initial":1, "encounter_met_ondate":1}',
        'CMS 147': '{"peritoneal_dialysis":0, "hemodialysis":1, "Influenza":0, "Encounter_influeza_met_ondate":1, "Infleza_season":0, "has_brithdate":1, "age_gte_6":1, "peritoneal_dialysis":1, "peritoneal_dialysis_met_ondate":0, "hemodialysis":1, "hemodialysis_met_ondate":0, "office_visit":1, "outpatient":0, "care_service":1, "health_care":1, "patient_interaction":0, "initial_office_0_to_17":1, "initial_office_0_to_18":0, "individual_Counselling":1, "group_counselling":0, "care_service":1, "nursing_facility":0, "facility_visit":1, "wellness_visit":0, "established_office_visit":0, "service_office_visit":1, "encounter_met_ondate":1}',
        'CMS 155': '{ "has_brithdate":1, "age_bw_3to17":1 , "office_visit":0, "individual":0, "establishe_office_visit":1, "initial_office_visit":0, "group_counseling":0, "home_healthcare":1, "encounter_on_metdate":0}',
        'CMS 165': '{ "has_brithdate":1, "age_bw_18to85":1, "office_visit":0, "wellness_visit":0, "established_office_visit":0, "Initial_office_visit":0, "home_healthcare":0, "encounter_met_ondate":0, "diagnosis_hypertension":0, "diagnosis_hypertension_6_less_after_metondate":1, "diagnosis_hypertension_overlap_met_ondate":0}'
      };
      ...
      denexcluconditions = {
        'CMS 68': '{"":""}',
        'CMS 69': '{"palliative_care_order":1, "palliative_care_order_on_or_before":0, "palliative_care_encounter":0, "palliative_care_encounter_on_or_before":0, "physical_exam_performed":1, "no_bmi_refused": 0, "no_bmi_during_encountered":0, "pregnancy": 0, "pregnancy_overlaps_measuring_period": 0}',
        'CMS 74': '{"discharge_hospice":0, "home_hospice":1, "healthcare_facility":0, "hospice_order":1, "hospice_performed":1 }',
        'CMS 75': '{ "encounterd":0, "discharge_home_met_ondate":0, "discharge_healthcare_met_ondate":0, "interventioned_order":0, "interventioned_order_met_ondate":1, "interventioned_ambulatory":1, "interventioned_met_overlap_ondate":0}',
        'CMS 127': '{"encounterd":0, "discharge_home_met_ondate":0, "discharge_healthcare_met_ondate":0, "interventioned_order":0 , "interventioned_order_met_ondate":1, "interventioned_ambulatory":1, "interventioned_met_overlap_ondate":0 }',
        'CMS 138': '{"":""}',
        'CMS 147': '{"":""}',
        'CMS 155': '{ "diagnosis_pregnancy":0, "diagnosis_pregnancy_overlap_date":1, "encounter_inpatient":0, "encounter_inpatient_to_home":1, "encounter_inpatient_to_healthcare":0, "encounter_met_ondate":1, "intervention_order":1, "intervention_order_met_ondate":0, "intervention_performed":1, "intervention_met_ondate":0}',
        'CMS 165': '{ "esrd_services":0, "esrd_services_before_on_metdate":0, "access_for_dialysis":1, "access_for_dialysis_before_on_metdate":0, "kidney_transplant":0, "kidney_transplant_before_on_metdate":1, "dialysis_services":1, "dialysis_services_before_met_ondate":1, "diagnosis_pregnancy":0, "diagnosis_pregnancy_overlaps_ondate":0, "diagnosis_reneal":0, "diagnosis_reneal_overlaps_ondate":0, "kidney_transplant":0, "kidney_transplant_overlaps_ondate":0, "kidney_disease":1, "kidney_disease_overlaps_ondate":0, "encounter_inpatient":1, "encounter_inpatient_home_procedure":0, "encounter_inpatient_healthcare_procedure":0, "encounter_inpatient_on_metdate":0, "order_ambulatory":1, "order_ambulatory_on_metdate":0, "performed_ambulatory":0, "performed_ambulatory_overlaps_ondate":1}'
      };

      denexcepconditions = {
        'CMS 68': '{ "encountered":0, "encounter_met_ondate":0, "notperformed":0, "procedure_done":0 }',
        'CMS 69': '{ "nobmi":1, "nobmi_reason": 0, "nobmi_reason_met": 0, "highbmi_no_medication":0, "highbmi_medical_reason":0, "highbmi_reason_met":0, "highbmi_no_followup":0, "highbmi_no_followup_reason":0, "highbmi_no_followup_met":0, "lowbmi_no_medication":0, "lowbmi_medical_reason":0, "lowbmi_reason_met":0, "lowbmi_no_followup":0, "lowbmi_no_followup_reason":0, "lowbmi_no_followup_met":0, "noreferral":0, "noreferral_reason":0, "noreferral_reason_met":0}',
        'CMS 74': '{"nodata":1}',
        'CMS 75': '{"":""}',
        'CMS 127': '{"":""}',
        'CMS 147': '{ "Allergey_influenza_vaccine":0, "Allergey_influenza_vaccine_overlaps_metdate":0, "diagnosis_influenza_vaccine":0, "diagnosis_influenza_vaccine_overlaps_metdate":0, "egg_influenza_vaccine":1, "egg_influenza_vaccine_overlaps_metdate":1, "immunization_influenza_vaccine":0, "immunization_influen_vaccine_overlap_metdate":1, "procedure_influenza_vaccine":0, "procedure_influenza_vaccine_metdate":1, "communication_influenza_vaccine":0, "communication_influenza_vaccine_on_metdate":1}',
        'CMS 155': '{"":""}',
        'CMS 165': '{"":""}',
        CMS138:{'Population 1: Screened for tobacco use at least once within 24 mos' : '{"tobacco_user":0, "diagnosis":0, "diagnosis_met_overlap_ondate":1, "assessment":0, "assessment_met_before_24mons":1, "assessment_medical_reason_met_in":0, "no_tobacco_cessation_counseling":0, "no_pharmacotherapy_ordered":0, "limited_life":0, "limited_life_overlaps_on_metdate":1, "medication_not_ordered":1, "medication_not_ordered_same_after_date":0, "medication_not_ordered":1, "medication_not_ordered_before_on_metdate":1, "medication_not_ordered_in_medical_reason":0, "intervention_tobacco_user":0, "intervention_tobacco_user_same_after_date":1, "intervention_tobacco_user_before_date":0, "intervention_tobacco_user_in_medical_reason":1, "assessment_tobacco_user":0, "assessment_tobacco_before_metdate":1, "assessment_tobacco_in_medical_reason":0 }',
                'Population 3: Screened for tobacco use at least once within 24 mos AND received cessation intervention if identified as a tobacco user' : '{"tobacco_user":0, "diagnosis":0, "diagnosis_met_overlap_ondate":1, "assessment":0, "assessment_met_before_24mons":1, "assessment_medical_reason_met_in":0, "no_tobacco_cessation_counseling":0, "no_pharmacotherapy_ordered":0, "limited_life":0, "limited_life_overlaps_on_metdate":1, "medication_not_ordered":1, "medication_not_ordered_same_after_date":0, "medication_not_ordered":1, "medication_not_ordered_before_on_metdate":1, "medication_not_ordered_in_medical_reason":0, "intervention_tobacco_user":0, "intervention_tobacco_user_same_after_date":1, "intervention_tobacco_user_before_date":0, "intervention_tobacco_user_in_medical_reason":1, "assessment_tobacco_user":0, "assessment_tobacco_before_metdate":1, "assessment_tobacco_in_medical_reason":0 }',
                'Population 2: Received tobacco cessation intervention' : '{"tobacco_user":0, "tobacco_nonuser":1, "tobacco_met_ondate": 1, "pharmacotherapy_cesation":1, "pharmacotherapy_ordered":0, "tobacco_cessation_counseling":0, "medication_active_tobacco":1, "medication_active_tobacco_met_ondate":1, "medication_active_tobacco_before_met_ondate":1, "medication_order_tobacco":0, "medication_order_tobacco_before_met_ondate":0, "intervention_tobacco":1, "intervention_tobacco_same_after_metdate":0, "intervention_tobacco_before_met_ondate":1, "assessment_tobacco":0, "assessment_tobacco_start_24mons_before":1, "tobacco_nonuser":0, "tobacco_nonuser_24monts_before_date":1, "tobacco_non_user":1, "tobacco_user":0, "diagnosis":0, "diagnosis_met_overlap_ondate":1, "assessment":0, "assessment_met_before_24mons":1, "assessment_medical_reason_met_in":0, "no_tobacco_cessation_counseling":0, "no_pharmacotherapy_ordered":0, "limited_life":0, "limited_life_overlaps_on_metdate":1, "medication_not_ordered":1, "medication_not_ordered_same_after_date":0, "medication_not_ordered":1, "medication_not_ordered_before_on_metdate":1, "medication_not_ordered_in_medical_reason":0, "intervention_tobacco_user":0, "intervention_tobacco_user_same_after_date":1, "intervention_tobacco_user_before_date":0, "intervention_tobacco_user_in_medical_reason":1, "assessment_tobacco_user":0, "assessment_tobacco_before_metdate":1, "assessment_tobacco_in_medical_reason":0 }'
       }

      };

      numconditions = {
        'CMS 68': '{ "encountered":0, "encounter_met_ondate":0, "performed":0, "procedure_done":0}',
        'CMS 69': '{ "physical_exam_performed":1, "has_last_bmi_in_encounted_period":0, "bmi_not_null":0, "bmi_normal":0, "bmi_high":1, "bmi_low": 0}',
        'CMS 74': '{ "fluoride_met":0, "fluoride_met_ondate":0 }',
        'CMS 75': '{ "Diagnosised":0, "Diagnosised_met_ondate":1 }',
        'CMS 127': '{"Immunization_vaccine":1, "Immunization_vaccine_met_ondate":0, "procedure_vaccine":1, "procedure_vaccine_met_ondate":0 }',
        'CMS 147': '{ "communication_influzeea_vaccine":0, "communication_influzeea_vaccine_on_metdate":1, "immunization_influzeea_vaccine":0, "immunization_influzeea_vaccine_met_ondate":1, "procedure_influzeea_vaccine":0, "procedure_influzeea_vaccine_met_ondate":1}',
        'CMS 165': '{ "systolic_blood_pressure":0, "systolic_blood_pressure_not_null":1, "systolic_blood_pressure_met_ondate":1, "dialstolic_blood_pressure":0, "dialstolic_blood_pressure_on_metdate":0, "essential_hypertension":1, "essential_hypertension_6m_less_after_ondate":0, "essential_hypertension_overlaps_on_metdate":0, "outpatientVisit":0, "hypertensionDiagnosis":1, "hypertensiondiagnosis_overlap_outpatientVisit_metdate":0, "diastolicBP":0, "outpatientVisit_overlaps_diastolicBP_metdate":0, "systolicBP":1, "outpatientVisit_overlaps_systolicBP_metdate":1, "visitwithBP":1, "has_systolic_blood_pressure_less_than_140":0, "has_diastolic_blood_pressure_less_than_90":1}',
        CMS155: {'Population 1: Height, weight, and body mass index (BMI) percentile documentation' : '{"physical_exam_weight":0, "physical_exam_weight_met_ondate":0, "physical_exam_weight_not_null":0, "physical_exam_height":0, "physical_exam_height_met_ondate":0, "physical_exam_height_not_null":0, "physical_exam_percentile":0, "physical_exam_percentile_on_metdate":0, "physical_exam_percentile_not_null":0}',
                  'Population 2: Counseling for nutrition': '{ "Intervention_nutrition":0, "Intervention_nutrition_on_metdate":0}',
                  'Population 3: Counseling for physical activity': '{ "Intervention_physical_activity":0, "Intervention_physical_activity_on_metdate":0 }'},
        CMS138:{'Population 1: Screened for tobacco use at least once within 24 mos' : '{"tobacco_user":0, "tobacco_nonuser":1, "tobacco_met_ondate": 1, "pharmacotherapy_cesation":1, "pharmacotherapy_ordered":0, "tobacco_cessation_counseling":0, "medication_active_tobacco":1, "medication_active_tobacco_met_ondate":1, "medication_active_tobacco_before_met_ondate":1, "medication_order_tobacco":0, "medication_order_tobacco_before_met_ondate":0, "intervention_tobacco":1, "intervention_tobacco_same_after_metdate":0, "intervention_tobacco_before_met_ondate":1, "assessment_tobacco":0, "assessment_tobacco_start_24mons_before":1, "tobacco_nonuser":0, "tobacco_nonuser_24monts_before_date":1, "tobacco_non_user":1 }',
                'Population 3: Screened for tobacco use at least once within 24 mos AND received cessation intervention if identified as a tobacco user' : '{"tobacco_user":0, "tobacco_nonuser":1, "tobacco_met_ondate": 1, "pharmacotherapy_cesation":1, "pharmacotherapy_ordered":0, "tobacco_cessation_counseling":0, "medication_active_tobacco":1, "medication_active_tobacco_met_ondate":1, "medication_active_tobacco_before_met_ondate":1, "medication_order_tobacco":0, "medication_order_tobacco_before_met_ondate":0, "intervention_tobacco":1, "intervention_tobacco_same_after_metdate":0, "intervention_tobacco_before_met_ondate":1, "assessment_tobacco":0, "assessment_tobacco_start_24mons_before":1, "tobacco_nonuser":0, "tobacco_nonuser_24monts_before_date":1, "tobacco_non_user":1 }',
                'Population 2: Received tobacco cessation intervention' : '{"tobacco_user":0, "tobacco_nonuser":1, "tobacco_met_ondate": 1, "pharmacotherapy_cesation":1, "pharmacotherapy_ordered":0, "tobacco_cessation_counseling":0, "medication_active_tobacco":1, "medication_active_tobacco_met_ondate":1, "medication_active_tobacco_before_met_ondate":1, "medication_order_tobacco":0, "medication_order_tobacco_before_met_ondate":0, "intervention_tobacco":1, "intervention_tobacco_same_after_metdate":0, "intervention_tobacco_before_met_ondate":1, "assessment_tobacco":0, "assessment_tobacco_start_24mons_before":1, "tobacco_nonuser":0, "tobacco_nonuser_24monts_before_date":1, "tobacco_non_user":1, "tobacco_user":0, "diagnosis":0, "diagnosis_met_overlap_ondate":1, "assessment":0, "assessment_met_before_24mons":1, "assessment_medical_reason_met_in":0, "no_tobacco_cessation_counseling":0, "no_pharmacotherapy_ordered":0, "limited_life":0, "limited_life_overlaps_on_metdate":1, "medication_not_ordered":1, "medication_not_ordered_same_after_date":0, "medication_not_ordered":1, "medication_not_ordered_before_on_metdate":1, "medication_not_ordered_in_medical_reason":0, "intervention_tobacco_user":0, "intervention_tobacco_user_same_after_date":1, "intervention_tobacco_user_before_date":0, "intervention_tobacco_user_in_medical_reason":1, "assessment_tobacco_user":0, "assessment_tobacco_before_metdate":1, "assessment_tobacco_in_medical_reason":0 }'
               }

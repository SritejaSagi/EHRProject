...
export class ProblemlistComponent implements OnInit {
  ...
  disableApplyButtonProblemlist(){
    var Provider_Id = this.problemreportform.value.ProviderId == null ? "":this.problemreportform.value.ProviderId;
    var StartDate = this.problemreportform.value.StartDate == null ? "": this.problemreportform.value.StartDate;
    var EndDate = this.problemreportform.value.EndDate == null ? "": this.problemreportform.value.EndDate;
  ...
  downloadProblemListExcel(){
    if(this.problemreportlist.data.length != 0){
      this.tableutil.exportAsExcelFileProblem(this.problemreportlist.data, 'Problem-List');
    }
  }
}
